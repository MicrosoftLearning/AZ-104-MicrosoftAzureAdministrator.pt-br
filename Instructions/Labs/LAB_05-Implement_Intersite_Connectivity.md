...
1. Na página de máquinas virtuais, selecione **Criar** e selecione **Máquina virtual**.

1. Na guia Básico, use as informações a seguir para preencher o formulário e selecione **Avançar: Discos >**. Para qualquer configuração não especificada, deixe o valor padrão.
    ...
    | Imagem (Ver todas as imagens) | **Datacenter do Windows Server 2019 – x64 Gen2** (observe suas outras opções) |
...
1. Use as informações a seguir para configurar a rede virtual e clique em **Ok**. Se necessário, remova ou substitua as informações existentes.
    ...
    | Configuração | Valor | 
    | --- | --- |
    | Nome | `CoreServicesVnet` (Criar ou editar) |
    | Intervalo de endereços | `10.0.0.0/16`  |
    | Nome da sub-rede | `Core` | 
    | Intervalo de endereços da sub-rede | `10.0.0.0/24` |

1. Selecione a guia **Monitoramento**. Em Diagnóstico de inicialização, selecione **Desabilitar**.
...
1. Use as informações a seguir para concluir os campos na página **Solução de problemas de conexão**.
    ...
    | Tipo de destino      | **Selecione uma máquina virtual**   |
...
1. Em CoreServicesVnet, em Emparelhamentos, clique em **+ Adicionar**. Se não for especificado, use o padrão. 
    ...
    | Rede virtual    | **ManufacturingVnet (az104-rg5)**  |
    | Permitir que "CoreServicesVnet" acesse "ManufacturingVnet"            | selecionado (padrão) |
    | Permitir que "CoreServicesVnet" receba tráfego encaminhado de "ManufacturingVnet" | selecionadas |
    ...
    | Permita que 'ManufacturingVnet' receba tráfego encaminhado de 'CoreServicesVnet' | selecionadas  |
...
1. Clique em **Sub-redes** e, em seguida, **+ Associar**. Conclua a configuração.
    ...
    | Configuração | Valor | 
    | --- | --- |
    | Rede virtual | **CoreServicesVnet (az104-rg5)** |
    | Sub-rede | **Básico** |    
