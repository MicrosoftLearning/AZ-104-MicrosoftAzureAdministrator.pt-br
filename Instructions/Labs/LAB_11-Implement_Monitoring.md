...
1. Baixe os arquivos de laboratório **\\Allfiles\\Labs\\11\\az104-11-vm-template.json** para seu computador.
...
1. Localize e selecione o arquivo **\\Allfiles\\Labs\\11\\az104-11-vm-template.json** e selecione **Abrir**.
...
1. Selecione **Habilitar** ao lado da máquina virtual.

1. Siga os padrões, selecione **Revisar + habilitar** e, em seguida, **Habilitar**.  
...
1. Continue trabalhando em seu alerta. Vá para a guia **Ações**, selecione **Usar grupos de ações** e selecione **Criar grupo de ações** na folha **Selecionar grupo de ações**.
...
1. Selecione **Avançar: Detalhes >** e insira estas configurações:
